...
<div class="productlist">
    ...
    <div class="products">
		...
		?>
            <tr height="20px">
            <td align="center">
			<a href="?page=invoice&cart=<?php echo($GLOBALS['cart']) ?>&orderid=<?php echo($row[$i]['orderid']) ?>&action=history">
            	<u>
				<?php echo($row[$i]['orderid']) ?>
                </u>
            </a>
            </td>
            <td align="center"><?php echo($row[$i]['orderdate']) ?></td>
            <td align="center">
            <?php
		...
		?>
            ...
            <td align="center"><strong><?php echo($totalitems); ?></strong></td>
            <td align="right"><strong>$<?php echo($totalamount); ?></strong></td>
            </tr>
