...
<h3>Edit Customers</h3>
            ...
            <form action="?page=customersave" method="post" onsubmit="return validcus();">
			  ...
			  <table width="592" border="0" cellspacing="0" cellpadding="0">
                ...
                <td width="392"><input type="text" name="txtfirstname" id="txtfirstname" value="<?php echo($customer[0]['firstname']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>Last Name:</td>
                <td><input type="text" name="txtlastname" id="txtlastname" value="<?php echo($customer[0]['lastname']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>Email Address:</td>
                <td><input name="txtemail" type="text" id="txtemail" value="<?php echo($customer[0]['email']) ?>" size="25"></td>
                </tr>
                <tr height="25px">
                <td>Gender:</td>
                <td>
				<?php if($customer[0]['sex'] == 0){ ?>                
                ...
                <tr height="25px">
                <td>Address:</td>
                <td><input type="text" name="txtaddress" id="txtaddress" value="<?php echo($customer[0]['address']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>Post Code:</td>
                <td><input type="text" name="txtpostcode" id="txtpostcode" value="<?php echo($customer[0]['postcode']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>City:</td>
                <td><input type="text" name="txtcity" id="txtcity" value="<?php echo($customer[0]['city']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>Country:</td>
                <td>
                ...
                <tr height="25px">
                <td>Phone Number:</td>
                <td><input type="text" name="txtphone" id="txtphone" value="<?php echo($customer[0]['phone']) ?>"></td>
                </tr>
                <tr height="25px">
                <td>Fax Number:</td>
                <td><input type="text" name="txtfax" id="txtfax" value="<?php echo($customer[0]['fax']) ?>"></td>
                </tr>
                ...
                <tr height="25px">
                <td>Password:</td>
                <td><input type="text" name="txtpwd" id="txtpwd" value="<?php echo($customer[0]['password']) ?>"></td>
