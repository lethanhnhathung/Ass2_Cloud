...
<form method="post" action="?page=categoriessave" onsubmit="return editcat();">
	<input type="hidden" name="categoriesid"  id="categoriesid" value="<?php echo($row[0]['categoriesid']) ?>">
	<input type="text" name="categoriesname"  id="categoriesname" value="<?php echo($row[0]['categoriesname']) ?>">
    <BR/>
