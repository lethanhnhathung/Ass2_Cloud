...
<form method="post" action="?page=paymentsave">
	<input type="hidden" name="paymentid"  id="paymentid" value="<?php echo($row[0]['paymentid']) ?>">
	<input type="text" name="paymentname"  id="paymentname" value="<?php echo($row[0]['paymentname']) ?>">
    <BR/>
