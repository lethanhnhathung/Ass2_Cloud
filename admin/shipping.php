...
?>
	<tr height="25px">
		...
		<td align="center">
            <a href="?page=shippingedit&id=<?php echo($row[$i][0]) ?>">
                <img src="img/b_edit.png" width="16" height="16" />
            </a>
        </td>
		<td align="center"><a href="?page=shippingdelete&id=<?php echo($row[$i][0]) ?>"  onClick="return confirm('Do you want to delete <?php echo($row[$i][1]) ?> catogry?');"><img src="img/b_drop.png" width="16" height="16" /></a></td>
    </tr>
<?php
	}
?>
