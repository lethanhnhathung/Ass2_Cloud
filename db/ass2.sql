...
-- Thời gian đã tạo: Th6 18, 2023 lúc 09:21 AM
...
(1, 'test', 'asdf', 'test', 0, 'asdf', 'asdf', '0', '17', 'adsfa', 'ad', 'test'),
...
(41, 'Logitech Keyboard', 'Logitech Classic Keyboard 200 USB', 12, '15.00', 8, '2014-04-10', 'keyboard_4.jpg');
...
--
ALTER TABLE `categories`
  MODIFY `categoriesid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
