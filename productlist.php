<?php
	...
	$cateid = isset($_GET['cart']);
	$find = isset($_REQUEST['find']);
        	...
        	<div class="product_table">	
			  ...
			  <table width="588" border="0" cellspacing="0" cellpadding="0">
                ...
                <td width="196" align="center">
                    ...
                    <tr align="center">
						<td class="info_product">
							...
							<p class="textprice"><span >$<?php echo($row[$i-1]['price']); ?></span></p>
							<br/>                    
							...
							<a href="?page=addcart&cart=<?php echo($GLOBALS['cart']) ?>&pid=<?php echo($row[$i-1]['productid']); ?>">
								<span class="add-to-cart">Add To Cart <i class='bx bxs-cart-alt add-to-cart-I' ></i></span>
                ...
                <td width="196" align="center" class="rightline">
                   ...
                   <p class="textprice"> <span >$<?php echo($row[$i-1]['price']); ?></span><br />  </p>                  
                    <?php if($row[$i-1]['qty'] == 0){ ?>
                        <img src="img/out_of_stock.png" width="68" height="19" />
                    <?php }else{ ?>
                    <a href="?page=addcart&cart=<?php echo($GLOBALS['cart']) ?>&pid=<?php echo($row[$i-1]['productid']); ?>">
