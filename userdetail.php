	...
	<div class="productlist">
        ...
        <div class="products">
        	...
        	<div class="product_table">	
                ...
                <td colspan="2">
                <input type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&cart=<?php echo($GLOBALS['cart']) ?>'" />&nbsp;<input type="button" value="View Cart" onclick="javascript:window.location='?page=addcart&cart=<?php echo($GLOBALS['cart']) ?>'" />&nbsp;<input type="submit" value="Update Profile" />&nbsp;<input type="button" value="Order History" onclick="javascript:window.location='?page=orderhistory&cart=<?php echo($GLOBALS['cart']) ?>'" />
                </td>
                </tr>
