...
<table width="460px" cellpadding="0" cellspacing="0">
    ...
    <td colspan="3" align="right">
        <input type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&amp;cart=<?php echo($GLOBALS['cart']) ?>'" />
        <input type="button" value="Back to Cart" onclick="javascript:window.location='?page=addcart&cart=<?php echo($GLOBALS['cart']) ?>'" />        <input type="submit" value="Next" />    </td>
    </tr>
</table>
</form>
</div>
