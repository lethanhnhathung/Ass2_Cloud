	...
	<div class="productlist">
        ...
        <div class="products">
			...
			<?php } ?>
                ...
                <?php }else{ ?>
                <input type="button" value="Back" onclick="javascript:window.location='?page=payment&cart=<?php echo($GLOBALS['cart']) ?>'" />	
				<input type="button" value="Finish" onclick="javascript:window.location='?page=finish&cart=<?php echo($GLOBALS['cart']) ?>'" />	                <?php } ?>
                  </td>
                </tr>
				</table>
          </div>
