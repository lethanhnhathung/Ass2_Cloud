        ...
        <table width="580" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="30px">
            <td colspan="6" align="right">
              <input type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&cart=<?php echo ($GLOBALS['cart']) ?>'" /> <input type="button" value="Update" onclick="defineAction('update', '<?php echo ($GLOBALS['cart']) ?>');" />
              <input type="button" value="Delete" onclick="defineAction('delete', '<?php echo ($GLOBALS['cart']) ?>');" />
              <input type="button" value="Checkout" onclick="defineAction('checkout', '<?php echo ($GLOBALS['cart']) ?>');" />
            </td>
          </tr>
